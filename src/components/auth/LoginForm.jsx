            ...
            <div className="relative z-10">
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                <div>
                  ...
                  />
                  {errors.email && (
                    <div className="text-sm text-yellow-200">{errors.email}</div>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.password && (
                    <div className="text-sm text-yellow-200">{errors.password}</div>
                  )}
                </div>
                ...
                <button
                  type="submit"
                  className="w-full bg-[#391b1b] py-2 rounded font-bold text-white hover:opacity-90"
                >
                </button>
              </form>
